...
function trimEstablishmentName(data) {
  if (!data || !Array.isArray(data.records)) return data;

  return {
    ...data,
    records: data.records.map((record) => {
      const value = record?.fields?.['Establishment Name'];
      ...
      return {
        ...
        fields: {
          ...record.fields,
          'Establishment Name': value.trimEnd(),
        },
      };
    }),
  };
